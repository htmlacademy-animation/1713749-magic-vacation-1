...
class FullPageScroll {
  constructor() {
    ...
    this.screenPlug = document.querySelector(`.screen__plug`);
  ...
  changeVisibilityDisplay() {
    const currentScreen = this.screenElements[this.activeScreen].classList.contains(`screen--prizes`);
    const screenStory = [...this.screenElements].find((element) => element.classList.contains(`screen--story`) && element.classList.contains(`active`));

    if (currentScreen && screenStory) {
      this.screenPlug.classList.add(`screen__plug--active`);
      ...
      this.screenPlug.classList.remove(`screen__plug--active`);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _typography_build__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./typography-build */ "./source/js/modules/typography-build.js");


const introTitle = new _typography_build__WEBPACK_IMPORTED_MODULE_0__["default"](document.querySelector(`.intro__title`), {
  letterDelays: [3, 2, 1, 1, 3, 2, 1, 4, 1, 1, 3, 0],
  delay: 100,
  nextWordDelay: 200,
});

const introDate = new _typography_build__WEBPACK_IMPORTED_MODULE_0__["default"](document.querySelector(`.intro__date`), {
  letterDelays: [4, 2, 1, 3, 0, 1, 0, 3, 1, 1, 4, 0, 2],
  delay: 1000,
});

const storyTitle = new _typography_build__WEBPACK_IMPORTED_MODULE_0__["default"](document.querySelector(`.slider__item-title`), {
  letterDelays: [2, 1, 4, 3, 2, 1, 0],
});

const prizesTitle = new _typography_build__WEBPACK_IMPORTED_MODULE_0__["default"](document.querySelector(`.prizes__title`), {
  letterDelays: [4, 2, 1, 3, 3],
  delay: 200,
});

const rulesTitle = new _typography_build__WEBPACK_IMPORTED_MODULE_0__["default"](document.querySelector(`.rules__title`), {
  letterDelays: [3, 1, 0, 2, 3, 2, 1],
});

const gameTitle = new _typography_build__WEBPACK_IMPORTED_MODULE_0__["default"](document.querySelector(`.game__title`), {
...
class AccentTypographyBuild {
  ...
  prepareText() {
    ...
    const content = this._element.textContent.trim().split(` `).reduce((fragment, word, index) => {
  ...
  createLetters(word, index) {
    const wordDelay = this._options.nextWordDelay ? this._options.nextWordDelay * index : 0;

    return word.split(``).reduce((fragment, letter) => {
      const span = document.createElement(`span`);
      const { duration = 400, delay = 0, timingFunction = `ease-out` } = this._options;
      span.textContent = letter;
      span.style.transition = `${duration}ms ${timingFunction} ${delay + wordDelay + this._delayGenerator.next().value}ms`;
      fragment.append(span);
      return fragment;
    }, document.createDocumentFragment());
  }
